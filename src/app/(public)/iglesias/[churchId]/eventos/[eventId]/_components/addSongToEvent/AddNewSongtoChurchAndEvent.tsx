import {
  ...
  getSongsOfChurch,
} from '@iglesias/[churchId]/canciones/_services/songsOfChurchService';
import {
  Button,
  Modal,
  ModalBody,
...
import { SongPropsWithoutId } from '@iglesias/[churchId]/canciones/_interfaces/songsInterface';
...
export const AddNewSongtoChurchAndEvent = ({
  ...
  useEffect(() => {
    if (statusAddSongToEvent === 'success') {
      ...
      refetch();
      if (goToSong) {
        router.push(`/iglesias/${params.churchId}/canciones/${newSong?.id}`);
      }
      onOpenChange();
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
