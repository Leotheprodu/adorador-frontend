          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-lg border-2 border-slate-200 bg-white/80 py-2 pl-10 pr-4 text-sm transition-all duration-200 focus:border-brand-pink-600 focus:outline-none focus:ring-2 focus:ring-brand-pink-200"
              />
            </div>
