      ...
      <div className="space-y-4">
          ...
          <div className="h-2 w-full rounded-full bg-default-200">
            <div
              className={`h-2 rounded-full ${
                membersUsage > 80 ? 'bg-danger' : 'bg-primary'
              }`}
        ...
        <div>
          ...
          <div className="h-2 w-full rounded-full bg-default-200">
            <div
              className={`h-2 rounded-full ${
                songsUsage > 80 ? 'bg-danger' : 'bg-primary'
              }`}
        ...
        <div>
          ...
          <div className="h-2 w-full rounded-full bg-default-200">
            <div
              className={`h-2 rounded-full ${
                eventsUsage > 80 ? 'bg-danger' : 'bg-primary'
              }`}
        ...
        {/* People Per Event Limit */}
        <div>
          <div className="mb-1 flex justify-between text-sm">
            <span>Personas simultáneas por evento</span>
            <span className="font-bold text-primary">
              Máx. {limits.maxPeoplePerEvent}
            </span>
          </div>
          <div className="text-xs text-default-400">
            Este límite aplica para cada evento individua que realices.
          </div>
        </div>
      </div>
