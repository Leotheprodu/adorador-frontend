...
import { TransposeChanger } from '@app/(public)/grupos/[churchId]/eventos/[eventId]/_components/updatingElements/components/TransposeChanger';
      ...
      {(provided) => (
        ...
        >
          ...
          <Link
            ...
            href={`/grupos/${params.churchId}/canciones/${data.song.id}`}
          >
