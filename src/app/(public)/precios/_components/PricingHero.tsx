...
import { marketingMessages, zamrNameExplanation } from '../_content/pricingContent';
        ...
        <section className="relative overflow-hidden bg-gradient-hero px-4 py-16 transition-colors duration-300 dark:bg-gradient-dark-hero sm:px-6 lg:px-8 lg:py-20">
            <div className="relative mx-auto max-w-4xl">
                <div className="text-center">
                    ...
                    <div className="mx-auto mb-8 max-w-md rounded-2xl border border-brand-purple-200 bg-white/50 p-6 backdrop-blur-sm transition-colors duration-300 dark:border-brand-purple-800 dark:bg-brand-purple-900/30">
                        <div className="mb-2 flex items-center justify-center gap-2">
                            <MusicNoteIcon className="h-6 w-6 text-brand-purple-600 dark:text-brand-purple-400" />
                            <h2 className="text-2xl font-bold text-brand-purple-700 dark:text-brand-purple-300">
                                {zamrNameExplanation.title}
                            </h2>
                        </div>
                        <p className="mb-1 text-sm font-medium text-gray-600 dark:text-gray-400">
                            {zamrNameExplanation.subtitle}
                        </p>
                        <p className="mb-2 text-base font-semibold text-brand-purple-600 dark:text-brand-purple-400">
                            {zamrNameExplanation.meaning}
                        </p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            {zamrNameExplanation.description}
                        </p>
                    </div>
