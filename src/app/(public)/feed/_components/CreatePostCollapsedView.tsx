...
export const CreatePostCollapsedView = ({
  ...
  return (
    <div className="p-4">
      <div
        className="flex cursor-pointer items-center gap-2 rounded-xl p-2 transition-all duration-200 hover:bg-default-100 dark:hover:bg-default-200 sm:gap-3 sm:p-3"
        onClick={onExpand}
      >
        <Avatar
          size="md"
        ...
        />
        <div className="flex min-h-[44px] min-w-0 flex-1 items-center rounded-full border border-default-200 bg-gradient-to-r from-default-100 to-default-50 px-3 text-foreground-500 transition-all duration-200 hover:border-brand-purple-200 hover:from-default-200 hover:to-default-100 hover:shadow-sm dark:border-default-300 dark:from-default-200 dark:to-default-100 dark:hover:border-brand-purple-300 dark:hover:from-default-300 dark:hover:to-default-200 sm:px-4">
